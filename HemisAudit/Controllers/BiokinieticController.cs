...
namespace HemisAudit.Controllers
{
    ...
    public class BiokinieticController : Controller
    {
        ...
        {
            var result = await RequireDataAnalystAsync(
                async () => await _biokinetic.GetColumnsAsync(request.Server, request.Database, request.Driver, request.BiokinieticTable));
            return Json(result);
        }
        ...
        private bool CanViewWorkspaceResults(string role, BiokinieticWorkspaceState? workspace)
        {
